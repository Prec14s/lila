...
<div class="max-w-xl mx-auto px-4 py-10 sm:py-14 text-center">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-coffee-100 p-5 mt-6 text-left card-hover">
        ...
        <div class="flex justify-between items-center mb-3 text-sm border-b border-coffee-100 pb-2">
            ...
            <span class="font-extrabold text-coffee-800 bg-coffee-100 px-2.5 py-0.5 rounded-lg">🪑 <?php echo e($order->table_number ?? '-'); ?></span>
        </div>
        ...
        <div class="mt-3 flex gap-2 flex-wrap">
            <span class="inline-block text-xs font-semibold px-3 py-1 rounded-full <?php echo e($order->paymentStatusColor()); ?>">
                <?php echo e($order->paymentStatusLabel()); ?>

            </span>
            <span class="inline-block text-xs font-semibold px-3 py-1 rounded-full <?php echo e($order->paymentCategoryColor()); ?>">
                <?php echo e($order->paymentCategoryIcon()); ?> <?php echo e($order->paymentCategoryLabel()); ?> · <?php echo e($order->paymentMethodLabel()); ?>
    ...
    <?php if($order->payment_status === 'rejected'): ?>
        <div class="mt-4 rounded-2xl bg-red-50 border border-red-200 p-4 text-left text-red-800">
            ...
            <p class="text-sm font-semibold mt-1.5 bg-white p-3 rounded-xl border border-red-200 shadow-xs"><?php echo e($order->rejection_reason ?? 'Bukti pembayaran tidak sesuai atau belum valid.'); ?></p>
            <p class="text-xs text-red-600 mt-2">Silakan hubungi kasir/staf warkop untuk mengonfirmasi ulang.</p>
        </div>
    <?php endif; ?>

    <a href="<?php echo e($waOwnerLink); ?>" target="_blank"
    ...
    <a href="<?php echo e(route('order.status', ['order_number' => $order->order_number])); ?>"
    ...
    <a href="<?php echo e(route('menu.index')); ?>" class="block mt-4 text-coffee-400 text-sm underline">Pesan menu lainnya</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\lila\resources\views/customer/success.blade.php ENDPATH**/ ?>